...
def update_release_information(writable: bool = False) -> Dict:
    """Update the release information and return the manifest."""
    ...
    with open(os.path.join("game", "System", "release_info.json"), 'r') as release_data:
        lsb_release: Dict = json.load(release_data)
...
if __name__ == "__main__":
    update_release_information(writable=True)
